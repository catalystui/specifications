...
* Some low-level memory behaviour may require `ctypes` or implementation-specific behaviour.
* Python type hints are not enforced at runtime.
* Python supports properties, but setter behaviour may be omitted.
