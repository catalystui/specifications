...
| `0x42` | WARNING | DEPRECATED | The operation completed, but it used a deprecated feature or behaviour. The operation may no longer work in the future. | |
...
| `0x85` | ERROR | NOT_IMPLEMENTED | The operation failed because the requested feature or behaviour is not yet implemented. | |
