...
- $\forall i \in \{0,\dots,k+1\}$, $u_i$ es una unidad de código ASCII
...
- $\forall i \in \{0,\dots,k+1\}$, $u_i$ es una unidad de código CP1252
...
- $\forall i \in \{0,\dots,k+1\}$, $u_i$ es una unidad de código UTF-8
...
- $\forall i \in \{0,\dots,k+1\}$, $u_i$ es una unidad de código UTF-16LE
