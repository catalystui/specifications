...
CatalystUI está diseñado en torno a la claridad, la consistencia y la representación fiel de la interacción entre humanos y computadoras. El idioma forma parte de esa interacción. Si un usuario no puede entender las etiquetas, instrucciones, advertencias, controles, configuración o contenido esencial de un sistema, entonces el sistema no ha comunicado con claridad, incluso si la funcionalidad subyacente técnicamente funciona.
