...
A bit is any $b \in \{0,1\}$.

### Nibble

A nibble is any $(b_0,\dots,b_3)$ such that for all $i \in \{0,\dots,3\}$, $b_i \in \mathrm{Bit}$.
...
A byte is any $(b_0,\dots,b_7)$ such that for all $i \in \{0,\dots,7\}$, $b_i \in \mathrm{Bit}$.
...
The following definition conforms to the IEEE 754 standard for single-precision floating-point representation. It defines how a 32-bit binary sequence is interpreted as a floating-point number, including special cases for zero, infinity, and NaN (Not a Number).
...
The following definition conforms to the IEEE 754 standard for double-precision floating-point representation. It defines how a 64-bit binary sequence is interpreted as a floating-point number, including special cases for zero, infinity, and NaN (Not a Number).
...
A Unicode codepoint is any $e \in \mathbb{Z}$ such that $0 \leq e \leq 0x10FFFF$.
...
The sequence is said to be null-terminated.
